...
{
	round2_logic(buf, 1, md5_k[16], S21);
	round2_logic(buf, 6, md5_k[17], S22);
	round2_logic(buf, 11, md5_k[18], S23);
	round2_logic(buf, 0, md5_k[19], S24);
	round2_logic(buf, 5, md5_k[20], S21);
	round2_logic(buf, 10, md5_k[21], S22);
	round2_logic(buf, 15, md5_k[22], S23);
	round2_logic(buf, 4, md5_k[23], S24);
	round2_logic(buf, 9, md5_k[24], S21);
	round2_logic(buf, 14, md5_k[25], S22);
	round2_logic(buf, 3, md5_k[26], S23);
	round2_logic(buf, 8, md5_k[27], S24);
	round2_logic(buf, 13, md5_k[28], S21);
	round2_logic(buf, 2, md5_k[29], S22);
	round2_logic(buf, 7, md5_k[30], S23);
	round2_logic(buf, 12, md5_k[31], S24);
}
...
{
	round4_logic(buf, 0, md5_k[48], S41);
	round4_logic(buf, 7, md5_k[49], S42);
	round4_logic(buf, 14, md5_k[50], S43);
	round4_logic(buf, 5, md5_k[51], S44);
	round4_logic(buf, 12, md5_k[52], S41);
	round4_logic(buf, 3, md5_k[53], S42);
	round4_logic(buf, 10, md5_k[54], S43);
	round4_logic(buf, 1, md5_k[55], S44);
	round4_logic(buf, 8, md5_k[56], S41);
	round4_logic(buf, 15, md5_k[57], S42);
	round4_logic(buf, 6, md5_k[58], S43);
	round4_logic(buf, 13, md5_k[59], S44);
	round4_logic(buf, 4, md5_k[60], S41);
	round4_logic(buf, 11, md5_k[61], S42);
	round4_logic(buf, 2, md5_k[62], S43);
